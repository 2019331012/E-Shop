  ...
  closeModal();
    ...
    <div class="tableman btn bg-gray-100 flex-grow p-4">
      ...
      <div class="bg-white p-4 btn rounded-lg shadow">
        <h3 class="text-lg font-bold btn mb-4">Users</h3>
        <table class="table btn">
          <thead>
            <tr>
              <th class="py-2 btn px-4 border-b">Name</th>
              <th class="py-2 px-4 btn border-b">Email</th>
              <th class="py-2 px-4 btn border-b">Account Number</th>
              <th class="py-2 px-4 btn border-b">Password</th>
              <th class="py-2 px-4 btn border-b">Account Balance (taka)</th>
              <th class="py-2 px-4 btn border-b w-1/4">Actions</th>
