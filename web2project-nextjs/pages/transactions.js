...
return(
  ...
  <div class="flex h-screen">
    ...
    <div class="tableman bg-gray-100 flex-grow p-4 btn">
      ...
      <div class="bg-white p-4 rounded-lg shadow btn">
        ...
        <table class="table btn">
          <thead>
            <tr>
              <th class="btn py-2 px-4 border-b">ID</th>
              <th class="btn py-2 px-4 border-b">FROM</th>
              <th class="py-2 btn px-4 border-b">TO</th>
              <th class="py-2 px-4 btn border-b">AMOUNT</th>
              <th class="py-2 px-4 btn border-b">TIME</th>
             </tr>
          </thead>
          <tbody>
            {transactions.map(transaction=>(
            <tr class={transaction.from==="ecommerce@example.com"||transaction.from==="ecommerce@ecommerce.com"||transaction.from==="admin@gmail.com"?"rowcolor-green btn border-b py-2 px-2":"rowcolor-red btn border-b py-2 px-2"}>
